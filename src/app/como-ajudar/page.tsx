...
export default function ComoAjudar() {
  return (
    <div className="bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {/* Compartilhar */}
          <div className="bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-700 hover:shadow-xl transition-shadow">
        ...
        <div className="bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-700 mb-16">
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Encontre a Pessoa</h3>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Acesse os Detalhes</h3>
                <p className="text-gray-300 mb-3">
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Envie Suas Informações</h3>
                <p className="text-gray-300 mb-3">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-purple-800 rounded-lg p-4">
                    <h4 className="font-semibold text-purple-100 mb-2">Informações Básicas</h4>
                  ...
                  <div className="bg-purple-800 rounded-lg p-4">
                    <h4 className="font-semibold text-purple-100 mb-2">Anexos (Opcional)</h4>
                    <ul className="text-sm text-purple-200 space-y-1">
        ...
        <div className="bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-700 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-white mb-2">Observe Detalhes</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-white mb-2">Mantenha Distância</h3>
              <p className="text-sm text-gray-300">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-white mb-2">Registre Tudo</h3>
              <p className="text-sm text-gray-300">
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-8 text-center text-white border border-purple-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="tel:197"
              className="border-2 border-purple-400 text-purple-400 px-6 py-3 rounded-lg font-semibold hover:bg-purple-400 hover:text-gray-900 transition-colors"
            >
              Ligar para 197
            </a>
          </div>
